...
# threshold, module-map, composite-definition, and Methods/Results records.

CP8_MANIFEST <- list(
  panel = "CP8",
  primary_event_col = "n_cd3_cd4_pos",
  thresholds = c(CD3=2.0, CD4=2.0, CD45RA=2.0, CD62L=2.2, CD27=2.0,
                 CCR6=1.5, IL7RA=1.5, CCR4=1.5, CD25=1.5,
                 CD25_HIGH=2.0, CXCR5=1.5),
  expected_markers = c("CD3", "CD4", "CD45RA", "CD62L", "CD27", "CCR6",
  ...
  score_definitions = list(
    CP8_CD4_composition_depletion_score = list(
      positive = character(),
      negative = c("pct_cd3_pos_total", "pct_cd4_pos_total", "pct_cd3_cd4_pos_total", "pct_cd4_within_cd3")
    ),
    CP8_CD4_memory_differentiation_score = list(
      positive = c("pct_memory_like", "pct_tem_like", "pct_temra_like", "pct_cd27_neg",
                   "pct_memory_cd27neg", "pct_cd62lneg_cd27neg"),
      negative = c("pct_naive_like", "pct_naive_cd27pos", "median_CD45RA_in_CD3CD4", "median_CD62L_in_CD3CD4")
    ),
    CP8_Treg_like_enrichment_score = list(
      positive = c("pct_cd25pos_il7ralow_treg_like", "pct_cd25high_il7ralow_treg_enriched",
                   "pct_ccr4_cd25pos_il7ralow", "pct_ccr4_cd25high_il7ralow",
                   "pct_cd25pos_il7ralow_within_memory", "pct_ccr4pos_within_treg_like",
    ...
    CP8_CCR6_CCR4_helper_remodeling_score = list(
      positive = c("pct_ccr6_pos", "median_CCR6_in_CD3CD4", "pct_ccr4_pos",
                   "median_CCR4_in_CD3CD4", "pct_ccr6pos_th17_like",
                   "pct_ccr4pos_ccr6pos", "pct_ccr6pos_within_cxcr5pos"),
      negative = character()
    ),
    CP8_Tfh_attenuation_score = list(
      positive = character(),
      negative = c("pct_cxcr5_pos", "pct_cxcr5pos_tfh_like", "median_CXCR5_in_CD3CD4",
                   "pct_ccr4pos_cxcr5pos", "pct_cxcr5pos_within_ccr6pos")
    )
  ),
  integrated_score = "CP8_integrated_CD4_helper_regulatory_remodeling_score",
  targeted_outcomes = c(
    "pct_cd3_cd4_pos_total", "pct_cd4_within_cd3", "pct_naive_like", "pct_memory_like",
    "pct_tem_like", "median_CD62L_in_CD3CD4", "pct_il7ra_low", "pct_cd25_high",
    "pct_cd25pos_il7ralow_treg_like", "pct_cd25high_il7ralow_treg_enriched",
    "pct_ccr4_cd25pos_il7ralow", "pct_ccr6_pos", "pct_ccr4_pos", "pct_cxcr5_pos"
  ),
  benchmarks = list(
    n_files = 850, n_model = 832, n_healthy_model = 398, n_cancer_model = 434,
    median_total_events = 299655, median_primary_events = 26156,
    integrated_beta = 0.528, matched_pairs_5y = 265, matched_pairs_10y = 273
  )
)
